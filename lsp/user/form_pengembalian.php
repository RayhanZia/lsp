...
<head>
    ...
    <style>
        /* CSS untuk mengatur tampilan form */
.form {
  width: 50%;
  margin: 50px auto;
  padding: 20px;
...
/* CSS untuk mengatur tampilan label */
label {
  display: block;
  font-size: 16px;
  margin-bottom: 5px;
...
/* CSS untuk mengatur tampilan input */
input, select {
  font-size: 16px;
  padding: 5px;
  border: 1px solid #ccc;
...
/* CSS untuk mengatur tampilan tombol submit */
button[type="submit"] {
...
/* CSS untuk mengatur tampilan select */
select {
  width: 100%;
}

/* CSS untuk mengatur tampilan error message */
.error {
  color: red;
  font-size: 14px;
  margin-bottom: 10px;
