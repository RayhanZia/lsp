...
<div class="w3-sidebar w3-bar-block w3-card" style="display:none" id="mySidebar">
  ...
  <div class="sidebar">
      <ul class="dik">
      <a href="../index.php" class="w3-bar-item w3-button w3-hover-blue"><i class="fa fa-home">Dashboard</i></a>
  <a href="peminjaman.php" class="w3-bar-item w3-button w3-hover-blue"><i class="fa fa-search">Peminjaman</i></a>
  <a href="pengembalian.php" class="w3-bar-item w3-button w3-hover-blue"><i class="fa fa-envelope">Pengembalian</i></a>
  <a href="profil.php" class="w3-bar-item w3-button w3-hover-blue"><i class="fa fa-globe"></i>Profil Saya</a>
  <a href="../logout.php" class="w3-bar-item w3-button w3-hover-blue"><i class="fa fa-globe"></i>Log Out</a>
        </ul>
    </div>
</div>
